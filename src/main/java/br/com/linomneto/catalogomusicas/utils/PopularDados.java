package br.com.linomneto.catalogomusicas.utils;
...
public class PopularDados {
    ...
    public void cadastrarMusicas() {
        ...
        musica1.setData(new Date());
        musica1.setNome("Serenissima");
        ...
        musica2.setData(new Date());
        musica2.setNome("All My Love");
        ...
        for (Musica musica : listaMusica) {
            Musica salvarMusica = service.save(musica);
